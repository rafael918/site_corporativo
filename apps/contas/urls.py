...
urlpatterns = [
    ...
    path('atualizar-me/', views.atualizar_usuario, name='atualizar_meu_usuario'),
    path('atualizar-usuario/<slug:username>/', views.atualizar_usuario, name='atualizar_usuario_outro'),
